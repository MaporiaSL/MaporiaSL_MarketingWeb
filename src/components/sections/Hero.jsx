    ...
    return (
        <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute inset-0 z-0">
                <div className="w-full h-full bg-gradient-to-br from-teal-900 via-slate-900 to-black animate-pulse">
                    {/* In production, replace this div with a <video> tag */}
                    {/* <video autoPlay loop muted playsInline className="object-cover w-full h-full" src="/assets/srilanka-loop.mp4" /> */}
                </div>
